				...
				<div class="row">
					<div class="box col-md-12">
                       ...
                       <table width="100%" border="0" cellspacing="0" height="10px"cellpadding="0" style=" color:#FFFFFF">
							<tr class="font">
							<td bgcolor="#4682B4">Performance Goal</td>
							</tr>
                       </table><br>
                       
                       <div style="width:100%; height:70px;padding:10px 20px; border:1px solid black"> 
                                             
                           <table border="1"  style="float:left;table-layout:fixed">
								<tr>
									<td>Name</td>
									<td>xxx</td>							
								</tr>
							...
							<table border="1" style="float:left;margin-left:40px">
								<tr>
									<td>EHR</td>
									<td>xxxxxx</td>
								</tr>
					   ...
					   <table id="kbo"></table><br>
					   
					   <font size="2" color="black">Individual Development Plan(Used for goal setting instead assessment)</font>
