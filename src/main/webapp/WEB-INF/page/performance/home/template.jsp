...
<body>
	...
	<div class="ch-container">
		...
		<div class="panel panel-default" style="margin:40px 100px">
		   <div style="padding:5px;color:white;font-size:18px; height:40px;background:#4682B4">Template Download</div>
		   <div style="border:1px solid gray;border-top:none">
		     <div style="color:red;padding:10px;font-size:17px">Instruction：XXXXXX </div>
		      
		        <!-- <table id="template"></table> -->
		      
		      </br></br></br></br></br></br></br></br></br></br>
		      
		      <hr width="98%" style="height:3px; z-index:1; background-color: #AAAAAA">
