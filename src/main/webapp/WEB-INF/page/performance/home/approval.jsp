			...
			<div id="content" class="col-lg-10 col-sm-10">
				...
				<div class="row">
					<div class="box col-md-12">
						...
						<table border="1" align="center" bordercolor="#32CD32" height="170px" class="col-md-12">    
							<tr>
                       ...
                       <table width="100%" border="0" cellspacing="0" height="10px"cellpadding="0" style=" color:#FFFFFF">
							<tr class="font">
							<td bgcolor="#4682B4">Latest Performance</td>
							</tr>
                       </table>
					   ...
					   <div style="border:1px solid #000">
						   <table width="100%" border="0 solid black" cellspacing="0" height="200px"cellpadding="0" style=" color:black">
								<tr>
								  <td width="15%">Approval Feedback</td>
								  <td>
								     <table width="100%" border="1 solid black" cellspacing="0" height="200px"cellpadding="0" style=" color:black">
								        <tr>
								           <td></td>
								        </tr>
								     </table>
						...
						<div class="form-group">
						    ...
						    <input type="button" value="Batch export"
