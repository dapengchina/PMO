			...
			<div id="content" class="col-lg-10 col-sm-10">
				...
				<div class="box col-md-12">
						<div class="box-inner" >
							...
							<div class="panel panel-default"  style="border:1px solid black">	
								 <div class="panel-body" >										
										...
										<div class="col-lg-10">
											<textarea rows="3" readonly="readonly" id="lobApprovalFeedback" style="border:1px solid black" class="form-control" ></textarea>
										</div>
								 </div>
							</div>						
								...
								<div class="form-group" >
										...
										class="button btn btn-primary" data-dismiss="modal" onclick="reject()"
										style="background-color: #D5D5D5; border: 0 none; border-radius: 4px; color: #FFFFFF; cursor: pointer; display: inline-block; font-size: 15px; font-weight: bold; height: 32px; line-height: 32px; margin: 0 5px 10px 0; padding: 0; text-align: center; text-decoration: none; vertical-align: top; white-space: nowrap; width: 100px; margin:auto ;">
									    </div>
									    <div style="text-align:left;width:80%;float:left">
									    <input type="button" value="Approve" href="#"
										class="button btn btn-primary" data-dismiss="modal" onclick="approve()"
										style="background-color: #D5D5D5; border: 0 none; border-radius: 4px; color: #FFFFFF; cursor: pointer; display: inline-block; font-size: 15px; font-weight: bold; height: 32px; line-height: 32px; margin: 0 5px 10px 0; padding: 0; text-align: center; text-decoration: none; vertical-align: top; white-space: nowrap; width: 100px; margin:auto ;">
									    </div>
								</div>
								<br/><br/><br/>
						...
						<div class="panel panel-default">
                             ...
                             <div class="panel-body">
										...
										<div class="group">
											...
											<div class="col-sm-4">
												<input type="text" class="form-control" readonly="readonly" id="bu" value="${bu }"/>
											</div>
										</div>
										<div class="group">
											<label class="col-sm-2 control-label">DU</label>
											<div class="col-sm-4">
												<input id="duHid" type="hidden" value="${du}"/>
												<select class="form-control" data-bv-notempty id="du" data-bv-group=".group">
								...
								<div class="form-group" >
									    ...
									    <div style="text-align:left;width:80%;float:left">
										<input type="button" value="Clear" name="clearBtn" id="clearBtn" href="#"
											   class="button btn btn-primary" data-dismiss="modal"
											   onclick="clean()"
											   style="background-color: #D5D5D5; border: 0 none; border-radius: 4px; color: #FFFFFF; cursor: pointer; display: inline-block; font-size: 15px; font-weight: bold; height: 32px; line-height: 32px; margin: 0 5px 10px 0; padding: 0; text-align: center; text-decoration: none; vertical-align: top; white-space: nowrap; width: 100px; margin:auto ;">
									    </div>
					...
					<!-- search box end -->
						...
						<table id="queryLobApproveDetailsList" class="table table-thead-background"></table>
									...
									<div class="form-group">
											<div style="text-align:center;width:100%;">
												<a href="<%=path%>/service/performance/performanceLobApprove.html" class="button btn btn-primary" data-dismiss="modal" style="background-color: #D5D5D5; border: 0 none; border-radius: 4px; color: #FFFFFF; cursor: pointer; display: inline-block; font-size: 15px; font-weight: bold; height: 32px; line-height: 32px; margin: 0 5px 10px 0; padding: 0; text-align: center; text-decoration: none; vertical-align: top; white-space: nowrap; width: 100px; margin:auto ;">OK</a>
											</div>
									</div>
...
<div class="ch-container ">
    ...
    <script type="text/javascript" src="<%=path %>/js/pmo/performanceLobApproveDetails.js"></script>
