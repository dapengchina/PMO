				...
				<div class="box col-md-12">
						<div class="box-inner" >
							<div class="box-header well" data-original-title="" >
								<h2>
									<i class="glyphicon glyphicon-user"></i>  Management->绩效考评->初评->绩效评价
								</h2>
							</div>
										...
										<div class="container">
							             	<div class="form-group col-md-2">
							                    <div class="input-group">
							                        ...
							                        <input class="form-control w70" type="text" placeholder="XXX">
							                    </div>
							                </div>
							                ...
							                <div class="form-group col-md-2">
							                    <div class="input-group">
							                        ...
							                        <input class="form-control w70" type="text" placeholder="XXXXX">
							                    </div>
							                </div>
							                <div class="form-group col-md-2">
							                    <div class="input-group">
							                ...
							                <div class="form-group col-md-2">
							                    <div class="input-group">
							                        ...
							                        <input class="form-control w70" type="text" placeholder="PM">
							                    </div>
							                </div>
											<div class="form-group col-md-2">
							                    <div class="input-group">
							                        <span class="input-group-addon">考核主管</span>
							                        <input class="form-control w70" type="text" placeholder="XXX交付经理">
							                    </div>
							                </div>
							          </div>            							
