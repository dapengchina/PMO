...
function queryPercentage() {
	$.ajax({
		url : path + '/service/performanceLobApprove/report/percentage',
		dataType : "json",
		cache : false,
		type : "GET",
...
function loadManageEvaFinalList() {
	var queryUrl = path + '/service/performanceLobApprove/hrreport';
...
function detail(employeeId) {
	window.location.href = path+"/service/performanceLobApprove/lobDetailPage4/"+employeeId;
}
