...
public class PerformanceManageEvaBean {
    ...
    public PerformanceManageEvaBean(String ehr, String lobNo, String name, String hireDate, String position, String serviceLine, String bu, String du, String location, String keymember,
            String participate, String pm, String customerFeedback, String initialEvalution, String pmEvalution, String duEvalution, String duEvaManager, String achievement, String jump,
            String comments, String previous1Quarter, String previous2Quarter, String previous3Quarter) {
        super();
        this.ehr = ehr;
        this.lobNo = lobNo;
        this.name = name;
    ...
    public String toString() {
        return "PerformanceManageEvaBean [ehr=" + ehr + ", lobNo=" + lobNo + ", name=" + name + ", hireDate=" + hireDate + ", position=" + position + ", serviceLine=" + serviceLine + ", bu=" + bu
                + ", du=" + du + ", location=" + location + ", keymember=" + keymember + ", participate=" + participate + ", pm=" + manager + ", customerFeedback=" + customerFeedback
                + ", initialEvalution=" + initialEvalution + ", pmEvalution=" + pmEvalution + ", duEvalution=" + duEvalution + ", duEvaManager=" + duEvaManager + ", achievement=" + achievement
                + ", jump=" + jump + ", comments=" + comments + ", previous1Quarter=" + previous1Quarter + ", previous2Quarter=" + previous2Quarter + ", previous3Quarter=" + previous3Quarter + "]";
    }
