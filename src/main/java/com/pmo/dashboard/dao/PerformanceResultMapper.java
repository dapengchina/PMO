...
public interface PerformanceResultMapper {
     ...
     * void
     */
    public void preAssessment(@Param("groupassessmentmanager") String groupassessmentmanager,@Param("groupassessmentresult") String groupassessmentresult,@Param("result") String result,@Param("preAssessment") String preAssessment, @Param("state") String state,@Param("id") String id);
